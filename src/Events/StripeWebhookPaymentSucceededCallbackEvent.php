 ...
 * This is the same event like the Charge Succeeded and we can use it in case the Charge Succeeded didn't arrive as a
 ...
 * Class StripeWebhookPaymentSucceededCallbackEvent
